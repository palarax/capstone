...
def parse_voc_annotation(ann_dir, img_dir, cache_name, labels=LABELS):
    ...
    for d in ["cyclist", "pedestrians_on_phone", "person_backwords", "people_mobile"]:
        ...
        _parse(annotations_dir, img_dir,all_insts, seen_labels)
...
def _parse(ann_dir, img_dir, all_insts, seen_labels, labels=LABELS):
    if False:
